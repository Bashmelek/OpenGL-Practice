            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                if (cmd == "light") {
                    if (numused == numLights) { // No more Lights 
                        ...
                        if (validinput) {
							...
							int index = numused * 4;
							lightposn[index] = values[index++];
							lightposn[index] = values[index++];
							lightposn[index] = values[index++];
							lightposn[index] = values[index++];
							index = numused * 4;
							lightcolor[index] = values[index++];
							lightcolor[index] = values[index++];
							lightcolor[index] = values[index++];
							lightcolor[index] = values[index++];
                            ++numused; 
                ...
                // Note that no transforms/stacks are applied to the colors. 
                    ...
                    if (validinput) {
						...
						up[1] = values[7];
						up[2] = values[8];
						//up = Transform::upvector(up, (eyeinit - center));
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
                        ...
                        // Also keep in mind what order your matrix is!
						vec3 rotaxis(values[0], values[1], values[2]);
						mat3 rotate3 = Transform::rotate(values[3] * pi / 180.0, rotaxis);
						double one, two;
						one = rotate3[0][0]; two = rotate3[0][1];
						mat4 rotate4(rotate3[0][0], rotate3[0][1], rotate3[0][2], 0,
							rotate3[1][0], rotate3[1][1], rotate3[1][2], 0, 
							rotate3[2][0], rotate3[2][1], rotate3[2][2], 0, 
							0,0,0, 1);
						/*mat4 rotate4(rotate3[0][0], rotate3[1][0], rotate3[2][0], 0,
							rotate3[0][1], rotate3[1][1], rotate3[2][1], 0,
							rotate3[0][2], rotate3[1][2], rotate3[2][2], 0,
							0, 0, 0, 1);*/
